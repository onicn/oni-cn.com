defmodule Onicn.Buildings.AirFilter do
  ...
  summary [only: :spaced_out], "需要通电并消耗 5W 电力。"

  usage "用于清除沼泽区中的大量污染氧，以及其他污染氧来源。"
  usage "空气净化器的范围可以跨越透气砖和网格砖，即使网格砖里有水也可以隔着水吸取污染氧，疑似bug，可以利用这个特点，在污染氧房间上方隔水建造空气净化器，从污染氧房间分离出纯净的氧气。"
  usage "不会因周围气压过大而停止工作。"
  usage "由于污染水会挥发污染氧，因此在池子上方建造空气净化器可以缓慢地将污染水转化为氧气，可以产出比较珍贵的粘土来烧制陶瓷。"
