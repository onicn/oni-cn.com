...
defmodule Onicn.Categories.Other do
  @others [
    ...
    Others.Beta,
    Others.BoosterArt1,
    Others.BoosterCarry1,
    Others.BoosterConstruct1,
    Others.BoosterCook1,
    Others.BoosterDig1,
    Others.BoosterDig2,
    Others.BoosterFarm1,
    Others.BoosterMedicine1,
    Others.BoosterOp1,
    Others.BoosterOp2,
    Others.BoosterPilot1,
    Others.BoosterRanch1,
    Others.BoosterResearch1,
    Others.BoosterResearch2,
    Others.BoosterResearch3,
    Others.BoosterSuits1,
    Others.BoosterTidy1,
    Others.CrabShell,
    Others.CrabWoodShell,
    Others.DehydratedBerryPie,
    Others.DehydratedCurry,
    Others.DehydratedFoodPackage,
    Others.DehydratedMushroomWrap,
    Others.DehydratedQuiche,
    Others.DehydratedSalsa,
    Others.DehydratedSpiceBread,
    Others.DehydratedSpicyTofu,
    Others.DehydratedSurfAndTurf,
    Others.DewDrip,
    Others.DisposableElectrobankRawMetal,
    Others.DisposableElectrobankUraniumOre,
    Others.EggShell,
    Others.EmptyElectrobank,
    Others.FeatherFabric,
    Others.FunkyVest,
    Others.Gamma,
    Others.GarbageElectrobank,
    Others.GasGrassHarvested,
    Others.GeneShufflerRecharge,
    Others.GingerConfig,
    Others.GoldBellyCrown,
    Others.IceBellyPoop,
    ...
    Others.Kelp,
    Others.LeadSuit,
    Others.LubricationStick,
    Others.MissileBasic,
    Others.MissileLongRange,
    Others.OrbitalResearchDatabank,
    Others.OxygenMask,
    Others.PowerStationTools,
    Others.PrickleFlowerSeed,
    Others.ResearchDatabank,
    Others.RotPile,
    Others.SelfChargingElectrobank,
    Others.SwampLilyFlower,
    Others.TableSalt,
    Others.TallowLubricationStick,
    Others.WarmVest,
    Others.WoodLog,
    Others.WornAtmoSuit,
    Others.WornJetSuit,
    Others.WornLeadSuit,
    Others.WornOxygenMask
  ]
