defmodule Onicn.Elements.Hydrogen do
  ...
  summary "氢气是一种不可呼吸的#{Onicn.Categories.Gas.output(:link_name_icon)}。可用于发电，也可用于制冷。常见于腐蚀区。"
  ...
  usage "毛鳞壁虎在氢气环境中会生长芦苇纤维鳞片，滑鳞壁虎在氢气环境中会生长#{Onicn.Elements.Polypropylene.output(:link_name_icon)}。"
  usage "储存在氢气环境中的食物不会腐烂。 "

  production "腐蚀区有天然氢气存在。"
  production "电解器能将#{Onicn.Elements.Water.output(:link_name_icon)}电解成#{Onicn.Elements.Oxygen.output(:link_name_icon)}和氢气。1 千克/秒 水 = 888 克/秒 氧气 + 112 克/秒 氢气。"
